  ...
  <nav class="navigation">
    <section class="navigation-left">
      ...
      <div @keyup.enter="search()" class="navigation-search control has-icons-right">
        ...
        <svg @click="search()" class="input-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
          <g>
