    ...
    <section class="search">
      ...
      <div class="search-tables">
        <transition-group class="table-responsive" name="fade" tag="div">
          <table v-if="visibleTab === 0" class="table-panel search-table" :key="1">
            <thead>
              <tr>
                <th>LP</th>
          ...
          <table v-if="visibleTab === 1" class="table-panel search-table" :key="2">
            <thead>
              <tr>
                <th>LP</th>
                <th>Nazwa</th>
          ...
          <table v-if="visibleTab === 2" class="table-panel search-table" :key="3">
            <thead>
              <tr>
                <th>LP</th>
                <th>Nazwa</th>
          ...
          <table v-if="visibleTab === 3" class="table-panel search-table" :key="4">
            <thead>
              <tr>
                <th>LP</th>
                <th>Nazwa</th>
