<template>
  <main class="website-container">
    ...
    <div class="tab-contents">
        <table  v-if="visibleTab == 0" class="tab-content table">
          <thead>
            <th>LP</th>
        ...
        <table  v-if="visibleTab == 1" class="tab-content table">
          <thead>
            <th>LP</th>
            <th>Nazwa</th>
            <th>Edycja</th>
        ...
        <table  v-if="visibleTab == 2" class="tab-content table">
          <thead>
            <th>LP</th>
            <th>Nazwa</th>
            <th>Data</th>
        ...
        <table  v-if="visibleTab == 3" class="tab-content table">
          <thead>
            <th>LP</th>
            <th>Nazwa</th>
            <th>Data</th>
