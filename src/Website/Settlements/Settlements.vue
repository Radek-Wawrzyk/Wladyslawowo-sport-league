			...
			<div class="settlement-description">
				...
				<div class="description">
					...
					<table class="description-table">		
							<tr>Reprezentuje:</tr>
							<tr><th>Gmina: Puck</th></tr>
							<tr><th>Opis: Nowoczesne osiedle z wieloma młodymi, ambitnymi zawodnikami aspirującymi do aktywności w najlepszych lokalnych ligach</th></tr>
					</table>
				</div>
				...
				<div class="players-heading">
					...
					<table class="players-table">
						...
						<tbody>
							<tr>
								<th>
									<img class="settlement-player" src="@/Assets/Home/player.jpg"/>
									Mark Zuckerberg</th>
								<th>								
									<img class="settlement-img" src="@/Assets/Home/settlement.jpg"/>
									Kosakowo				
